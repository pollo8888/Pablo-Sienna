...
<head>
    ...
    <title>SIENNA MX - Empresas</title>
...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4 text-right">
                            <button type="button" class="btn btn-sienna" id="btnAddCompany">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?php echo count(array_filter($companies, function($c) { return $c['tipo_persona'] == 'moral'; })); ?></h3>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?php echo count(array_filter($companies, function($c) { return $c['tipo_persona'] == 'fisica'; })); ?></h3>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-secondary">
                                <div class="inner">
                                    <h3><?php echo count(array_filter($companies, function($c) { return $c['tipo_persona'] == 'fideicomiso'; })); ?></h3>
                                    <p>Fideicomisos</p>
                                </div>
                                <div class="icon">
                    ...
                    <div class="filter-section">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="searchCompany" class="form-control" placeholder="Nombre o RFC...">
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="row" id="companiesContainer">
                        <?php if(empty($companies)): ?>
                            <div class="col-12">
                                <div class="empty-state">
                                    ...
                                    <button type="button" class="btn btn-sienna btn-lg" id="btnAddFirstCompany">
                        ...
                        <?php else: ?>
                            <?php foreach($companies as $company): ?>
                                <div class="col-lg-4 col-md-6 company-item" data-name="<?php echo strtolower($company['name_company']); ?>" data-rfc="<?php echo strtolower($company['rfc_company']); ?>" data-tipo="<?php echo $company['tipo_persona']; ?>" data-date="<?php echo $company['created_at_company']; ?>">
                                    <div class="company-card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div class="company-title"><?php echo htmlspecialchars($company['name_company']); ?></div>
                                            ...
                                            <div class="company-info">
                                                <div class="mb-1">
                                                    ...
                                                    <strong>Razón Social:</strong> <?php echo htmlspecialchars($company['razon_social']); ?>
                                                </div>
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <strong>Teléfono:</strong> <?php echo htmlspecialchars($company['telefono']); ?>
                                                </div>
                                                <?php endif; ?>
                                                
                                                <div class="mb-1">
                                                    <i class="fas fa-calendar mr-2"></i>
                                                    <strong>Registrada:</strong> <?php echo date('d/m/Y', strtotime($company['created_at_company'])); ?>
                                                </div>
                                            </div>
                                            
                                            <div class="company-actions">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button type="button" class="btn btn-outline-info btn-view-company" data-id="<?php echo $company['id_company']; ?>" title="Ver detalles">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-outline-warning btn-edit-company" data-id="<?php echo $company['id_company']; ?>" title="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-outline-danger btn-delete-company" data-id="<?php echo $company['id_company']; ?>" data-name="<?php echo htmlspecialchars($company['name_company']); ?>" title="Eliminar">
                ...
                <form id="companyForm">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info-custom">
                            ...
                            Complete la información de la empresa. Los campos con <span class="required-asterisk">*</span> son obligatorios.
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rfc_company" name="company[rfc_company]" required maxlength="13" minlength="12" placeholder="ABC123456789" style="text-transform: uppercase;">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company[razon_social]" id="razon_social" required maxlength="150" placeholder="Chedraui Sociedad Anónima de Capital Variable">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="company[fecha_constitucion]" id="fecha_constitucion" max="<?php echo date('Y-m-d'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="telefono" name="company[telefono]" maxlength="15" placeholder="8123456789">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="company[email]" id="email" maxlength="100" placeholder="contacto@empresa.com">
                        ...
                        <div class="company-form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Estado</label>
                                        <input type="text" class="form-control" name="company[estado]" id="estado" maxlength="50" placeholder="Nuevo León">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Ciudad/Municipio</label>
                                        <input type="text" class="form-control" name="company[ciudad]" id="ciudad" maxlength="50" placeholder="Monterrey">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company[calle]" id="calle" maxlength="150" placeholder="Av. Constitución 123">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Colonia</label>
                                        <input type="text" class="form-control" name="company[colonia]" id="colonia" maxlength="100" placeholder="Centro">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company[num_exterior]" id="num_exterior" maxlength="10" placeholder="123">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Número Interior</label>
                                        <input type="text" class="form-control" name="company[num_interior]" id="num_interior" maxlength="10" placeholder="A">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="codigo_postal" name="company[codigo_postal]" maxlength="5" pattern="[0-9]{5}" placeholder="64000">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company[apoderado_nombre]" id="apoderado_nombre" maxlength="50" placeholder="Juan Carlos" style="text-transform: capitalize;">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Apellido Paterno</label>
                                        <input type="text" class="form-control" name="company[apoderado_apellido_paterno]" id="apoderado_apellido_paterno" maxlength="50" placeholder="García" style="text-transform: capitalize;">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Apellido Materno</label>
                                        <input type="text" class="form-control" name="company[apoderado_apellido_materno]" id="apoderado_apellido_materno" maxlength="50" placeholder="López" style="text-transform: capitalize;">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="apoderado_rfc" name="company[apoderado_rfc]" maxlength="13" pattern="^[A-Z]{4}[0-9]{6}[A-Z0-9]{3}$" placeholder="GALO800101ABC" style="text-transform: uppercase;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="apoderado_curp" name="company[apoderado_curp]" maxlength="18" pattern="^[A-Z]{4}[0-9]{6}[HM][A-Z]{5}[0-9A-Z][0-9]$" placeholder="GALO800101HDFRPN09" style="text-transform: uppercase;">
                        ...
                        <div class="company-form-section fideicomiso-section" id="fideicomiso-section" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company[fiduciario_nombre]" id="fiduciario_nombre" maxlength="100" placeholder="Banco Nacional de México SA">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fiduciario_rfc" name="company[fiduciario_rfc]" maxlength="13" placeholder="BNM840315PE6" style="text-transform: uppercase;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nombre(s)</label>
                                        <input type="text" class="form-control" name="company[fideicomitente_nombre]" id="fideicomitente_nombre" maxlength="50" placeholder="María Elena">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Apellido Paterno</label>
                                        <input type="text" class="form-control" name="company[fideicomitente_apellido_paterno]" id="fideicomitente_apellido_paterno" maxlength="50" placeholder="Rodríguez">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Apellido Materno</label>
                                        <input type="text" class="form-control" name="company[fideicomitente_apellido_materno]" id="fideicomitente_apellido_materno" maxlength="50" placeholder="Flores">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fideicomitente_rfc" name="company[fideicomitente_rfc]" maxlength="13" placeholder="ROFM800315AB2" style="text-transform: uppercase;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>CURP del Fideicomitente</label>
                                        <input type="text" class="form-control" id="fideicomitente_curp" name="company[fideicomitente_curp]" maxlength="18" placeholder="ROFM800315MDFDRR04" style="text-transform: uppercase;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nombre(s)</label>
                                        <input type="text" class="form-control" name="company[fideicomisario_nombre]" id="fideicomisario_nombre" maxlength="50" placeholder="Carlos Alberto">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Apellido Paterno</label>
                                        <input type="text" class="form-control" name="company[fideicomisario_apellido_paterno]" id="fideicomisario_apellido_paterno" maxlength="50" placeholder="Méndez">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Apellido Materno</label>
                                        <input type="text" class="form-control" name="company[fideicomisario_apellido_materno]" id="fideicomisario_apellido_materno" maxlength="50" placeholder="Silva">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fideicomisario_rfc" name="company[fideicomisario_rfc]" maxlength="13" placeholder="MESC750820CD1" style="text-transform: uppercase;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>CURP del Fideicomisario</label>
                                        <input type="text" class="form-control" id="fideicomisario_curp" name="company[fideicomisario_curp]" maxlength="18" placeholder="MESC750820HDFLRL09" style="text-transform: uppercase;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="company[numero_fideicomiso]" id="numero_fideicomiso" maxlength="20" placeholder="F/12345">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="company[fecha_fideicomiso]" id="fecha_fideicomiso" max="<?php echo date('Y-m-d'); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="viewCompanyModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header card-header-sienna">
