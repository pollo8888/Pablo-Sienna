<?php
  class WebController extends Connector {
    ...
    public function createFolder($data) {
      ...
      // Consulta SQL para insertar una nueva fila en la tabla 'folders'.
      // Los valores para 'created_at_folder' y 'updated_at_folder' se establecen a la fecha y hora actuales (NOW()).
      $query = "INSERT INTO folders(id_user_folder, id_customer_folder, fk_folder, key_folder, name_folder, first_fech_folder, second_fech_folder, chk_alta_fact_folder, chk_lib_folder, chk_orig_recib_folder, fech_orig_recib_folder, status_folder, created_at_folder, updated_at_folder) VALUES (?,?,?,?,?,?,?,?,?,?,?,1,NOW(),NOW())";
      // Parámetros para la consulta preparada. Se espera que $data contenga los siguientes índices:
      // 'id_user_folder', 'fk_folder', 'key_folder', 'name_folder', 'first_fech_folder', 'second_fech_folder', 'chk_alta_fact_folder', 'chk_lib_folder', 'chk_orig_recib_folder', 'fech_orig_recib_folder'
      $params = array(
      ...
      // Ejecuta la consulta preparada con los parámetros proporcionados.
      // Se espera que la función execute() maneje la ejecución segura de la consulta SQL.
      return $this->execute($query, $params);
    }
